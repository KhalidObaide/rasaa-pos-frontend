            ...
            <div className="flex flex-row">
              <div>
                <input
                  ...
                  placeholder="کلید"
                  className={`w-80 h-12  py-2 px-2 pr-5 text-right rounded-md outline-none mx-2 text-lg ${
                    activeInput
                      ? "border-solid border border-borderColor"
                ...
                {error && (
                  <div
                    style={{ color: "red" }}
                    className=" flex flex-row-reverse justify-end items-center text-right mb-2 mt-2 text-xs"
                  >
                    {`${error}`} <CiWarning className="w-4 h-4 " />
                  </div>
                )}
              </div>
              <input
