            ...
            <div className=" p-5 bg-white absolute z-index-4  top-40 right-31%  flex flex-col justify-center items-center rounded-md">
             ...
             <div className=" w-full flex flex-col justify-center items-center ">
                    ...
                    <div className="flex flex-row-reverse justify-around items-start">
                        <textarea
                         className="w-80 h-12  py-2 px-2 pr-5 text-right border-solid border border-gray_line rounded-md outline-none mx-2 text-lg resize-none"
                          placeholder='ملاحضات'
                          value={desc}
                ...
                <div className="w-full px-2 flex flex-row-reverse justify-start items-start mt-10">
                    ...
                    <button onClick={()=>setDisplayState(false)} className="bg-gray_button text-gray_fac text-lg py-2 px-4 mb-2 font-medium rounded-md ">لغو</button>
                </div>
            </div>    
        </div>
    )
